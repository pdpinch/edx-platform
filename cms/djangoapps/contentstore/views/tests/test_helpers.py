...
class HelpersTestCase(CourseTestCase):
    ...
    def test_xblock_studio_url(self):
        ...
        self.assertEqual(xblock_studio_url(chapter),
                         u'/course/slashes:MITx+999+Robot_Super_Course?show={escaped_usage_key}'.format(
                             escaped_usage_key='location%3AMITx%2B999%2BRobot_Super_Course%2Bchapter%2BWeek_1'
                         ))
        ...
        self.assertEqual(xblock_studio_url(sequential),
                         u'/course/slashes:MITx+999+Robot_Super_Course?show={escaped_usage_key}'.format(
                             escaped_usage_key='location%3AMITx%2B999%2BRobot_Super_Course%2Bsequential%2BLesson_1'
                         ))
